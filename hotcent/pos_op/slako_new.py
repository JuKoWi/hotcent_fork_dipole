...
DICT_IDENTICAL_DFTBPLUS = {102: [102], 85: [85, 119], 68: [68, 136], 38: [38], 21: [21, 55], 34: [34], 17: [17, 51], 6: [6], 2: [2], 0: [0]}
DFTBPLUS_SIMPLE = DICT_IDENTICAL_DFTBPLUS.keys() #order in which the integrals appear in the conventional .skf format
...
def dftbplus_to_full(path1, path2, to_file=False):
    ...
    dict_interchange = {102: [], 85: [], 68: [], 38: [-98], 21: [-81, -115], 34: [], 17: [], 6: [96], 2: [-32], 0: []}
    for i, idx_short in enumerate(DFTBPLUS_SIMPLE):
    ...
    if to_file:
        ...
        np.savetxt(fname=f'{title}_long.skf', X=combined_table, header=header, comments='')
