...
NUMSK = len(INTEGRALS)
DFTBPLUS_SIMPLE = [102, 85, 68, 38, 21, 34, 17, 6, 2, 0] #order in which the integrals appear in the conventional .skf format
...
def convert_sk_table(path1, path2, to_file=False):
    ...
    dict_identical = {102: [102], 85: [85, 119], 68: [68, 136], 38: [38], 21: [21, 55], 34: [34], 17: [17, 51], 6: [6], 2: [2], 0: [0]}
