...
INTEGRALS_DIPOLE = {
	...
	(62, 1, -1, 1, -1, 3, 2): lambda c1, c2, s1, s2: -0.67928328497763*np.sqrt(2)*np.sqrt(np.pi)*s1**2*s2**2*c2,
	...
	(90, 1, -1, 1, 1, 3, -2): lambda c1, c2, s1, s2: 0.67928328497763*np.sqrt(2)*np.sqrt(np.pi)*s1**2*s2**2*c2,
	...
	(154, 1, 1, 1, -1, 3, -2): lambda c1, c2, s1, s2: 0.67928328497763*np.sqrt(2)*np.sqrt(np.pi)*s1**2*s2**2*c2,
	...
	(190, 1, 1, 1, 1, 3, 2): lambda c1, c2, s1, s2: 0.67928328497763*np.sqrt(2)*np.sqrt(np.pi)*s1**2*s2**2*c2,
	...
	(218, 2, -2, 1, 0, 3, -2): lambda c1, c2, s1, s2: 0.67928328497763*np.sqrt(10)*np.sqrt(np.pi)*s1**2*s2**2*c1*c2,
	...
	(254, 2, -1, 1, -1, 3, 2): lambda c1, c2, s1, s2: -0.67928328497763*np.sqrt(10)*np.sqrt(np.pi)*s1**2*s2**2*c1*c2,
	...
	(282, 2, -1, 1, 1, 3, -2): lambda c1, c2, s1, s2: 0.67928328497763*np.sqrt(10)*np.sqrt(np.pi)*s1**2*s2**2*c1*c2,
	...
	(346, 2, 1, 1, -1, 3, -2): lambda c1, c2, s1, s2: 0.67928328497763*np.sqrt(10)*np.sqrt(np.pi)*s1**2*s2**2*c1*c2,
	...
	(382, 2, 1, 1, 1, 3, 2): lambda c1, c2, s1, s2: 0.67928328497763*np.sqrt(10)*np.sqrt(np.pi)*s1**2*s2**2*c1*c2,
	...
	(414, 2, 2, 1, 0, 3, 2): lambda c1, c2, s1, s2: 0.67928328497763*np.sqrt(10)*np.sqrt(np.pi)*s1**2*s2**2*c1*c2,
	...
	(446, 3, -3, 1, -1, 3, 2): lambda c1, c2, s1, s2: 0.113213880829605*np.sqrt(105)*np.sqrt(np.pi)*s1**4*s2**2*c2,
	...
	(474, 3, -3, 1, 1, 3, -2): lambda c1, c2, s1, s2: 0.113213880829605*np.sqrt(105)*np.sqrt(np.pi)*s1**4*s2**2*c2,
	(483, 3, -2, 1, -1, 1, 1): lambda c1, c2, s1, s2: 0.67928328497763*np.sqrt(2)*np.sqrt(np.pi)*s1**3*s2*c1,
	(487, 3, -2, 1, -1, 2, 1): lambda c1, c2, s1, s2: 0.67928328497763*np.sqrt(10)*np.sqrt(np.pi)*s1**3*s2*c1*c2,
	(493, 3, -2, 1, -1, 3, 1): lambda c1, c2, s1, s2: 0.339641642488815*np.sqrt(7)*np.sqrt(np.pi)*(5*c2**2 - 1)*s1**3*s2*c1,
	(495, 3, -2, 1, -1, 3, 3): lambda c1, c2, s1, s2: -0.113213880829605*np.sqrt(105)*np.sqrt(np.pi)*s1**3*s2**3*c1,
	(500, 3, -2, 1, 0, 2, -2): lambda c1, c2, s1, s2: 0.67928328497763*np.sqrt(10)*np.sqrt(np.pi)*s1**2*s2**2*c1**2,
	(506, 3, -2, 1, 0, 3, -2): lambda c1, c2, s1, s2: 3.28125*np.sqrt(3)*np.pi**(3/2)*s1**2*s2**2*c1**2*c2,
	(513, 3, -2, 1, 1, 1, -1): lambda c1, c2, s1, s2: 0.67928328497763*np.sqrt(2)*np.sqrt(np.pi)*s1**3*s2*c1,
	(517, 3, -2, 1, 1, 2, -1): lambda c1, c2, s1, s2: 0.67928328497763*np.sqrt(10)*np.sqrt(np.pi)*s1**3*s2*c1*c2,
	(521, 3, -2, 1, 1, 3, -3): lambda c1, c2, s1, s2: 0.113213880829605*np.sqrt(105)*np.sqrt(np.pi)*s1**3*s2**3*c1,
	(523, 3, -2, 1, 1, 3, -1): lambda c1, c2, s1, s2: 0.339641642488815*np.sqrt(7)*np.sqrt(np.pi)*(5*c2**2 - 1)*s1**3*s2*c1,
	...
	(542, 3, -1, 1, -1, 3, 2): lambda c1, c2, s1, s2: -0.339641642488815*np.sqrt(7)*np.sqrt(np.pi)*(5*c1**2 - 1)*s1**2*s2**2*c2,
	...
	(570, 3, -1, 1, 1, 3, -2): lambda c1, c2, s1, s2: 0.339641642488815*np.sqrt(7)*np.sqrt(np.pi)*(5*c1**2 - 1)*s1**2*s2**2*c2,
	...
	(634, 3, 1, 1, -1, 3, -2): lambda c1, c2, s1, s2: 0.339641642488815*np.sqrt(7)*np.sqrt(np.pi)*(5*c1**2 - 1)*s1**2*s2**2*c2,
	...
	(670, 3, 1, 1, 1, 3, 2): lambda c1, c2, s1, s2: 0.339641642488815*np.sqrt(7)*np.sqrt(np.pi)*(5*c1**2 - 1)*s1**2*s2**2*c2,
	(673, 3, 2, 1, -1, 1, -1): lambda c1, c2, s1, s2: -0.67928328497763*np.sqrt(2)*np.sqrt(np.pi)*s1**3*s2*c1,
	(677, 3, 2, 1, -1, 2, -1): lambda c1, c2, s1, s2: -0.67928328497763*np.sqrt(10)*np.sqrt(np.pi)*s1**3*s2*c1*c2,
	(681, 3, 2, 1, -1, 3, -3): lambda c1, c2, s1, s2: 0.113213880829605*np.sqrt(105)*np.sqrt(np.pi)*s1**3*s2**3*c1,
	(683, 3, 2, 1, -1, 3, -1): lambda c1, c2, s1, s2: -0.339641642488815*np.sqrt(7)*np.sqrt(np.pi)*(5*c2**2 - 1)*s1**3*s2*c1,
	(696, 3, 2, 1, 0, 2, 2): lambda c1, c2, s1, s2: 0.67928328497763*np.sqrt(10)*np.sqrt(np.pi)*s1**2*s2**2*c1**2,
	(702, 3, 2, 1, 0, 3, 2): lambda c1, c2, s1, s2: 3.28125*np.sqrt(3)*np.pi**(3/2)*s1**2*s2**2*c1**2*c2,
	(707, 3, 2, 1, 1, 1, 1): lambda c1, c2, s1, s2: 0.67928328497763*np.sqrt(2)*np.sqrt(np.pi)*s1**3*s2*c1,
	(711, 3, 2, 1, 1, 2, 1): lambda c1, c2, s1, s2: 0.67928328497763*np.sqrt(10)*np.sqrt(np.pi)*s1**3*s2*c1*c2,
	(717, 3, 2, 1, 1, 3, 1): lambda c1, c2, s1, s2: 0.339641642488815*np.sqrt(7)*np.sqrt(np.pi)*(5*c2**2 - 1)*s1**3*s2*c1,
	(719, 3, 2, 1, 1, 3, 3): lambda c1, c2, s1, s2: 0.113213880829605*np.sqrt(105)*np.sqrt(np.pi)*s1**3*s2**3*c1,
	(724, 3, 3, 1, -1, 2, -2): lambda c1, c2, s1, s2: -0.1171875*np.sqrt(14)*s1**4*s2**2/np.sqrt(np.pi),
	(730, 3, 3, 1, -1, 3, -2): lambda c1, c2, s1, s2: -0.113213880829605*np.sqrt(105)*np.sqrt(np.pi)*s1**4*s2**2*c2,
	...
	(766, 3, 3, 1, 1, 3, 2): lambda c1, c2, s1, s2: 0.113213880829605*np.sqrt(105)*np.sqrt(np.pi)*s1**4*s2**2*c2,
}
