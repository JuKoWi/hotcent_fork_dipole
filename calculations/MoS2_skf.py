...
def run_atomic_dft(
    element, configuration, valence, xc="GGA_X_PBE+GGA_C_PBE", scalarrel=False
):
        ...
        while (rmax < 700) and retry:
            try:
                ...
                atom.info["eigenvalues"] = {
                    nl: atom.get_eigenvalue(nl) for nl in atom.valence
                }
                atom.info["hubbardvalues"] = {
                    nl: atom.get_hubbard_value(nl, scheme="central", maxstep=1.0)
