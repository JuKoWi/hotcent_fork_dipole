...
wf_confGa = {
    "4s": PowerConfinement(r0=rcovGa, s=8.8),
    "4p": PowerConfinement(r0=rcovGa, s=8.8),
    "4d": PowerConfinement(r0=rcovGa, s=8.8),
}

wf_confAs = {
    "4d": PowerConfinement(r0=rcovMo, s=5.6),
...
off2cS.write(
    format=True, eigenvalues=eigenvaluesGa, filename_template="{el1}-{el2}dftb.skf"
)
...
off2cMo.write(
    format=True, eigenvalues=eigenvaluesAs, filename_template="{el1}-{el2}dftb.skf"
)
