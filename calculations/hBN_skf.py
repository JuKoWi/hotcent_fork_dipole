...
wfconfN = {
    "2s": PowerConfinement(r0=rcovN, s=13.4),
    "2p": PowerConfinement(r0=rcovN, s=13.4),
}

wfconfB = {
    "2s": PowerConfinement(r0=rcovB, s=10.4),
...
off2cN.write(
    format=True, eigenvalues=eigenvaluesN, filename_template="{el1}-{el2}dftb.skf"
)
...
off2cB.write(
    format=True, eigenvalues=eigenvaluesB, filename_template="{el1}-{el2}dftb.skf"
)
