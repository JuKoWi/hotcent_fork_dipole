...
print('B -- E_2s  | %s' % check(e_2s, 0.24990807910273996, eps_eig))
e_2p = atom1.get_epsilon('2p')
print('B -- E_2p  | %s' % check(e_2p, 0.47362603289831301, eps_eig))
...
print('H -- E_1s  | %s' % check(e_1s, 1.00949638195278960, eps_eig))
...
print('B-H sps S  | %s' % check_abs(S[9], -0.34627316, eps_sk))
print('B-H sps H  | %s' % check_abs(H[9], 0.29069894, eps_sk))
print('B-H sps H2 | %s' % check_abs(H2[9], 0.29077536, eps_sk))

S, H, H2 = sk.calculate_mels([('sps', '1s', '2p')], atom2, atom1, 
                             R, grid, areas)

print('H-B sps S  | %s' % check_abs(S[8], -0.47147340, eps_sk))
print('H-B sps H  | %s' % check_abs(H[8], 0.33033262, eps_sk))
print('H-B sps H2 | %s' % check_abs(H2[8], 0.33028882, eps_sk))
