...
def test_off2c(R, atom):
    ...
    HS_ref = {
        (R1, PBE_LibXC): {
            'sss': (-0.56660294, 0.49948849),
            'sps': (0.54226361, -0.56984249),
            'pps': (0.23153325, -0.18330373),
            'ppp': (-0.29839512, 0.46900458),
        },
        (R1, LDA_LibXC): {
            'sss': (-0.57081676, 0.50148653),
            'sps': (0.54656547, -0.57206067),
            'pps': (0.23101808, -0.17645414),
            'ppp': (-0.30160971, 0.47370149),
        },
        (R2, PBE_LibXC): {
